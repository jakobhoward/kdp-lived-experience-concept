...
window.I18N.zh = {
  ...
  "index.gateNoteBody": "作者用自己的话声明：这段经历是自己亲历的，这本书也是自己写的。Amazon 只展示作者的声明，并不为其真实性做认证。译本也欢迎，包括用 AI 翻译的译本。",

  "index.book1.title": "The Road from Manila",
  "index.book1.author": "Rosa Delgado",
  "index.book1.voice": "“1979 年我离开马尼拉。我先用塔加洛语写下这些，因为这些事在我记忆里，本来就是这种语言。”",
  "index.book1.starsAria": "4.4 星，共 5 星，214 条评分",
  "index.book1.coverAlt": "The Road from Manila 封面",

  "index.book2.title": "The Unseen Memoir",
  "index.book2.author": "一位第一次出书的作者",
  "index.book2.voice": "“这本书我在自家餐桌上写了四年，写的是我不再说话的那一年。”",
  "index.book2.starsAria": "4.3 星，共 5 星，127 条评分",
  ...
  "index.book3.starsAria": "4.5 星，共 5 星，2,341 条评分",
  "index.book3.coverAlt": "Letters Home 封面",

  "index.credits1": "Reader Discovery 团队：Jakob Picciotto · Pablo Ortega · Jalen Oscar Howard · Wanting Chao · 作者声明机制：Wanting 的方案（7 月 27 日）· 读者→作者互动层级：Pablo 的构想（7 月 27 日）· 合集定位：Chang 的 StoryCorps 重构（7 月 24 日）· 为上线提供依据的社区发现研究：Jalen（进行中）",
  ...
  "book.starsAria": "4.4 星，共 5 星，214 条评分",
  ...
  "book.attest.h3": "作者自述",
  "book.attest.quote": "“1979 年我离开马尼拉，只带了一个箱子和母亲的念珠。我不是作家——我做了三十一年护士。我先用塔加洛语写下这本书，因为这些事在我记忆里，本来就是这种语言，后来我和侄女一起翻译，也用了翻译工具帮忙。故事里的每一个字都是我的。这些我都亲身经历过。”",
  ...
  "book.attest.translationNote": "您读到的是 Rosa 声明的译文。她签署声明时用的原话，是她自己写下的。",

  "book.desc.lede": "因为每一段平凡的人生，都有一个值得记住的不平凡故事。",
  "book.desc.p1Html": "1979 年，Rosa Delgado 带着一份护士合同和一只箱子，在马尼拉登上飞机，那时她还不知道，此后十一年都见不到母亲。<em>The Road from Manila</em> 写的就是这中间的岁月——在一个她连做梦都要翻译的国家里上夜班，把汇款夹进生日卡片，一边想着故乡，一边慢慢把这里建成家。",
  "book.desc.p2": "这本回忆录先用塔加洛语写成，再由她和侄女一起译出。它写给每一个曾经离开的人——也写给留下来的人。",

  "book.meta.pagesValue": "287 页",
  "book.meta.pagesLabel": "纸书页数",
  ...
  "book.ask.sub": "作者已开启 · 每周回答",
  "book.ask.tier1Label": "关于本书的提问",
  "book.ask.tier1Body": "每本书每位读者可提一个问题；仅限已购买或通过 KU 借阅的读者。在 Rosa 发布答复之前，任何内容都不会公开。",
  "book.ask.tier2Label": "读者实时问答",
  "book.ask.tier2Body": "不定期举行，由作者安排时间。",
  "book.ask.note": "作者自己选择开放到哪一层——也可以完全不开放——并且随时可以更改。默认由作者自行管理：作者可以查看、回答或删除；Amazon 现有社区准则里的举报和屏蔽工具同样适用。我们绝不会透露作者的联系方式。",

  "book.buy.formatKindle": "Kindle",
  "book.buy.orBuy": "或花 $4.99 购买",
  ...
  "author.tabHome": "首页",
  "author.tabAbout": "简介",
  "author.tabBooks": "全部作品",
  "author.aboutH2": "关于作者",
  /* 下面这句里的“他们”指 Rosa 的孙子孙女——已点明含孙女的具体一群人，
     是汉语固有的混合群体复数，不是泛指的阳性形式。请勿在去性别化清理中改动。 */
  "author.bioHtml": "Rosa Delgado 做了三十一年护士，先在马尼拉，后来在芝加哥。<em>The Road from Manila</em> 是她的第一本书，先用塔加洛语写成，再和侄女一起译出。她没想过当作家，她只想把这些事记下来。她住得离孙子孙女不远；有他们，才有这本书。",
  ...
  "author.qa1.a": "前十年，每年十二月都想。后来有一年我发现，两边我都在想，才明白自己现在有两个家。第 14 章写的就是这件事。",
  "author.qa2.q": "先用塔加洛语写，让这本书有了什么不同？",
  "author.qa2.a": "全都不同了。有些记忆只留在它发生时的那种语言里。翻译的时候，我和侄女每一句话都要争一争。就是在这些争论里，这本书才变得诚实。",

  "author.popularH2": "最受欢迎",
  "author.bookTitle": "The Road from Manila",
  "author.starsAria": "4.4 星，共 5 星，214 条评分",
  "author.orBuy": "或花 $4.99 购买",
  ...
  "author.access.tier1Body": "每周回答；在 Rosa 发布之前不会公开。",
